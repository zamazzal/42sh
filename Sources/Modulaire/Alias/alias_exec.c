...
/*   Updated: 2020/01/18 05:39:34 by hessabra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * First check if the submitted command is an alias
 * using ft_aliasexist, afterword to get the value of
 * the alias use ft_getaliasvalue
**/
...
char		*ft_delquote(char *value)
{
	...
	new = (char *)ft_mmalloc(sizeof(char) * (ft_strlen(value) + 3));
	i = 0;
...
/**
 * Loopdetector should be initialized before the function call
